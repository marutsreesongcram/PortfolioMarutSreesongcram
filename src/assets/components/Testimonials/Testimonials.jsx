    ...
    <div className={styles.testimonials_con}>
        ...
        <div className={styles.testimonials_list}>
            <div className={styles.testimonial_items}>
                ...
                <image src="https://unsplash.com/photos/a-woman-in-a-business-suit-posing-for-a-picture-x7ksVaD2_VI" alt="Client" />
            ...
            <div className={styles.testimonial_items}>
                ...
                <image src="https://unsplash.com/photos/a-man-in-a-gray-suit-and-white-shirt-M7GBLqdNTjI" alt="Client" />
            ...
            <div className={styles.testimonial_items}>
                ...
                <image src="https://unsplash.com/photos/a-woman-in-a-pink-and-gold-dress-standing-in-front-of-a-sign-Z9NNpFtn8mw" alt="Client" />
